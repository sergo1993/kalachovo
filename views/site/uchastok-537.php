<?php
$this->title = "Земельный участок ИЖС №537 в д.Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земельный участок ИЖС №537 в д.Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description">
              <h1 style="text-align: center">Земельный участок под ИЖС №537 в д.Калачево..</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №537 в коттеджном поселке Калачево на ТЭЦ-3, размер участка 9,23 сотки. Участок под ИЖС на данный момент один из самых выгодных в третьей очереди поселка, его стоимость 430 000р, цена за сотку 46 587р.Расстояние до асфальта всего 100м.Участок угловой, что позволяет распланировать заезд с удобной стороны. Соседи строятся, по углам участка геодезистами выставлены колышки, есть отчет. </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/map-537.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/aero-537.jpg" alt="Фото 2">
			<img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/537-1.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/537-2.jpg" alt="Фото 4">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-537/map-537.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-537/aero-537.jpg" alt="Фото 2">
			<img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/537-1.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-537/537-2.jpg" alt="Фото 4">
        </div>
    </div>
