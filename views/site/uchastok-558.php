<?php
$this->title = "Земля в Калачево №558.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земля в Калачево №558.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Земля  в Калачево участок №558</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    часток №558 размером 8,63 сотки 410 000р, 47 508р за сотку.
                    Участок находится в третьей очереди поселка, на центральной улице в 300м от асфальтированный дороги.
                    Участок угловой, что позволяет в будущем распланировать заезд с удобной стороны, по длинной стороне соседом уже установлен забор из оцинкованного профлиста длиною 40м.                 <p  style="text-align: center; margin-bottom: 30px; font-weight: bold;">
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/map.jpg" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/4.jpg" alt="Фото 5">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-558/5.jpg" alt="Фото 6">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/4.jpg" alt="Фото 5">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-558/5.jpg" alt="Фото 6">
        </div>
    </div>
