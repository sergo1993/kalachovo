<?php
$this->title = "Участок под ИЖС в Иваново №500 в Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок под ИЖС в Иваново №500 в Калачево'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок под ИЖС в Иваново №500 в Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В третьей части деревни, на центральной улице в 150м от дороги Кохма-Харинка, продаётся земельный участок №500, общая площадь участка 8,54 сотки.Были проведены работы по выносу крайних точек участка на местности и по периметру вкопаны столбы.Участок угловой, что позволяет в дальнейшем организовать заезд с удобной стороны. Линия электропередачи идет по фасаду, что освобождает будущего собственника от установки дополнительной бетонной опоры и позволит в дальнейшем сэкономить при подключении электричества.Стоимость земельного участка <span class="стиль2">400 000р</span> без торга, цена за сотку <span class="стиль2">46 838   р</span>.На изображении приведенном ниже участок отмечен желтым цветом.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-500/map.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-500/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-500/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-500/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-500/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/4.jpg" alt="Фото 5">
        </div>
    </div>
