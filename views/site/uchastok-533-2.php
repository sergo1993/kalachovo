<?php
$this->title = "Половина участка №533 в Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Половина участка №533 в Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Половина участка №533 размером 5,33 сотки</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Есть возможность разделить участок №533 общей площадью 10,66 сотки и продать любую из его половин в размере 5,33 сотки по цене <span class="стиль2">245 000р</span>, за сотку <span class="стиль2">45 966р</span>.Раздел займет по времени 3 недели и будет выглядеть аналогично разделу участка №535 из которого были образованы участки №765 и №764.                <p  style="text-align: center; margin-bottom: 30px; font-weight: bold;">
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-533/533-2.jpg" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-533/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-533/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-533/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-533/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-533/533-2.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-533/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-533/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-533/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-533/4.jpg" alt="Фото 5">
