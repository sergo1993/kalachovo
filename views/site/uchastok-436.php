<?php
$this->title = "Дешевый участок во 2-ой очереди Калачево №436.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Дешевый участок во 2-ой очереди Калачево №436.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Дешевый участок во 2-ой очереди Калачево №436.</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №436 в деревне Калачево, размер участка 8 соток. Участок под ИЖС на данный момент самый выгодный во второй очереди, его стоимость 300 000р, цена за сотку 37 500р. По фасаду участка проходят столбы ЛЭП, что освободит будущего собственника от дополнительных трат в размере 10 000р на установку бетонной опоры.Соседи уже построились и живут.            </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-436/aero 436.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-436/map 436.jpg" alt="Фото 2">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-436/aero 436.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-436/map 436.jpg" alt="Фото 2">    
        </div>
    </div>
