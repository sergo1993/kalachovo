<?php
$this->title = "Земля ИЖС под номером №619 в Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земля ИЖС под номером №619 в Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Земля ИЖС на ТЭЦ-3 №619 в Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В третьей части деревни, срочно продаётся участок №619, размером <span class="стиль1">8.1 сотки</span>. По цене <span class="стиль1">440 000р</span>, <span class="стиль1">54 320р</span> за сотку.Участок располагается всего в 150м от асфальтированной дороги и в 420м от остановки общественного транспорта.На участке проведено вынесение границ на местности и в крайних точках геодезистами выставлены колышки.Цена без торга.                <p  style="text-align: center; margin-bottom: 30px; font-weight: bold;">
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-619/map.png" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-619/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-619/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-619/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-619/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-619/map.png" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-619/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-619/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-619/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-619/4.jpg" alt="Фото 5">
