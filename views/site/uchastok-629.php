<?php
$this->title = "Участок земли под строительство в Калачево №629.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок земли под строительство в Калачево №629.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок под застройку ИЖС в Калачево №629 </h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Участок находится в третьей очереди поселка, всего в 170м от асфальтированной дороги, продается по цене 420 000р. Электрическая линия ЛЭП идёт по фасаду участка, что освобождает будущего собственника от затрат в размере 10 000р на установку бетонного столба. По одной стороне участка соседом уже установлен забор из оцинкованного профлиста длиною 40м.Участок угловой, что позволит распланировать в будущем заезд с удобной стороны или сделать два заезда.Проведено вынесение границ на местности, есть отчет геодезистов.По углам участка вкопаны столбы.                <p  style="text-align: center; margin-bottom: 30px; font-weight: bold;">
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-629/map.jpg" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-629/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-629/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-629/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-629/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-629/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-629/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-629/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-629/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-629/4.jpg" alt="Фото 5">
        </div>
    </div>
