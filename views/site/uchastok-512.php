<?php
$this->title = "Участок №512 в коттеджном поселке Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок №512 в коттеджном поселке Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description">
              <h1 style="text-align: center">Участок №512 в коттеджном поселке Калачево.</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №512 в коттеджном поселке Калачево на ТЭЦ-3, размер участка 8,28 сотки. Участок под ИЖС на данный момент один из самых выгодных в третьей очереди поселка, его стоимость 440 000р, цена за сотку 53 140р.Расстояние до асфальта всего 300м, от центральной улицы поселка 115м.По широкой стороне участка соседом уже установлен забор из профлиста длиной 40 метров.Соседи уже построились и живут.            </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-512/aero 512.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-512/map 512.jpg" alt="Фото 2">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-512/aero 512.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-512/map 512.jpg" alt="Фото 2">
        </div>
    </div>
