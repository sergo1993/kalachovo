<?php
$this->title = "Участок 505 с выгодным расположением.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок 505 с выгодным расположением.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок №505 с отличным расположением</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В третьей части поселка на центральной улице, всего в 280м от дороги Кохма- Харинка продаётся участок под ИЖС в Калачево размером 8,42 сотки по цене <span class="стиль1">425 000р</span>, за сотку <span class="стиль1">50 475р</span>. Проведены работы по вынесению границ участка на местности, по периметру вкопаны столбы, написано завление на получение разрешения на строительство.                </p>
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-500/map.png" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-500/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-500/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-500/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-500/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-500/map.png" alt="Фото 1">
