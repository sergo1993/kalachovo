...
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'ИЖС под застройку дома в Калачево №625'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Земля ИЖС под застройку дома в Калачево уч.№625</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В третьей очереди поселка недалеко от асфальтированной дороги Кохма-Харинка продается участок №625.Это самый дешевый участок на данный момент в третьей очереди, цена 400 000р, за сотку 48 543р. Общая площадь земельного участка 8,24 сотки. Проведены геодезические работы по определению границ участка на местности, отчет о проведенных работах на руках, по углам участка вкопаны столбы. Линия ЛЭП идет по фасаду участка, что сократит будущие расходы при подключении электричества
                </p>
                ...
                <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-625/map.jpg" alt="Фото 1">
                <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-625/1.1.jpg" alt="Фото 2">
                <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-625/1.jpg" alt="Фото 3">
                <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-625/2.jpg" alt="Фото 4">
                <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-625/3.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-625/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-625/1.1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-625/1.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-625/2.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-625/3.jpg" alt="Фото 5">
        </div>
    </div>
