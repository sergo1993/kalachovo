<?php
$this->title = "ИЖС под застройку дома в Калачево №625.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земля ИЖС 8,46 сотки в Калачево на ТЭЦ-3'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок №644 в д.Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Продается участок №644, размером 8,46 сотки, который находится в третьей очереди поселка, всего в 100м от асфальтированной дороги,  цена 420 000р без торга.  По одной из длинных сторон участка соседом уже установлен забор из оцинкованного профлиста длиною 40м.Проведено вынесение границ на местности, есть отчет геодезистов.По углам участка вкопаны столбы.
                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/map.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/4.jpg" alt="Фото 5">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-644/5.jpg" alt="Фото 6">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/4.jpg" alt="Фото 5">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-644/5.jpg" alt="Фото 6">
        </div>
    </div>
