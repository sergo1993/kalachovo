<?php
$this->title = "Участок ИЖС №618 в деревне Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок ИЖС №618 в деревне Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description">
              <h1 style="text-align: center">Участок ИЖС №618 в деревне Калачево.</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №627 в коттеджном поселке Калачево на ТЭЦ-3, размер участка 8,08 сотки. Участок под ИЖС на данный момент один из самых выгодных в третьей очереди поселка, его стоимость 430 000р, цена за сотку 53 217р. Расстояние до асфальта всего 30м, до остановки общественного транспорта 400м.Линия электропередачи проходит по фасаду участка, что освободит будущего собственника от дополнительных затрат в размере 10 000р на установку бетонной опоры.По углам участка  выставлены колышки. </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-618/map-618.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-618/aero-618.jpg" alt="Фото 2">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-618/map-618.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-618/aero-618.jpg" alt="Фото 2">
