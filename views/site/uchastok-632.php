<?php
$this->title = "Земельный участок в Калачево номер 632";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земельный участок в Калачево номер 632'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Земельный участок в Калачево номер 632</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В третьей очереди поселка недалеко от асфальтированной дороги Кохма-Харинка продается участок №632. Общая площадь земельного участка 8,08 сотки. Проведены геодезические работы по определению границ участка на местности, по углам участка вкопаны столбы.                <p  style="text-align: center; margin-bottom: 30px; font-weight: bold;">
            ...
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-632/map.jpg" alt="Фото 1">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-632/1.jpg" alt="Фото 2">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-632/2.jpg" alt="Фото 3">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-632/3.jpg" alt="Фото 4">
            <img class="go" style="width: 701px; margin: 20px auto; display: block;" src="/images/uchastok-632/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-632/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-632/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-632/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-632/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-632/4.jpg" alt="Фото 5">
