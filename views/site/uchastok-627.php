<?php
$this->title = "Земельный участок ИЖС №627 в д.Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земельный участок ИЖС №627 в д.Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description">
              <h1 style="text-align: center">Земельный участок под ИЖС №627 в д.Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №627 в коттеджном поселке Калачево на ТЭЦ-3, размер участка 8,09 сотки. Участок под ИЖС на данный момент один из самых выгодных в третьей очереди поселка, его стоимость 420 000р, цена за сотку 51 915р.Расстояние до асфальта всего 100м, дорога до участка отсыпана боем кирпича. Участок угловой, что позволяет распланировать заезд с удобной стороны. По углам участка геодезистами выставлены колышки, есть отчет геодезистов. </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/map-627.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/aero-627.jpg" alt="Фото 2">
			<img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/627-1.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/627-2.jpg" alt="Фото 4">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-627/map-627.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-627/aero-627.jpg" alt="Фото 2">
			<img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/627-1.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-627/627-2.jpg" alt="Фото 4">
        </div>
    </div>
