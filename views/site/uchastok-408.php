<?php
$this->title = "408 участок по привлекательной цене, д.Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => '408 участок по привлекательной цене, д.Калачево'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">408 участок в д Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Во второй очереди поселка,срочно продается участок с кадастровым номером  37:05:030560:408,  размером <span class="стиль1">8 соток</span> за <span class="стиль1">365 000р</span>, по цене <span class="стиль1">45 625 р</span> за сотку.Участок находится на центральной улице второй части поселка с хорошими подъездными путями,он угловой, что позволит организовать заезд с любой удобной стороны.Линии ЛЭП идут по фасаду участка, поэтому будущему владельцу не придется тратиться на установку дорогостоящего бетонного столба.На данный момент это самый дешевый участок во второй очереди деревни.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-408/1.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-408/2.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-408/3.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-408/4.jpg" alt="Фото 4">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-408/1.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-408/2.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-408/3.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-408/4.jpg" alt="Фото 4">
        </div>
    </div>
