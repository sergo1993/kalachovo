<?php
$this->title = "Земельный участок №91 в деревне Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Земельный участок №91 в деревне Калачево'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Земельный участок №91 в деревне Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В первой части поселка неподалеку от деревни Тарбаево срочно продается участок под ИЖС с кадастровым номером 37:05:030560:91, размером 8 соток за <span class="стиль1">370 000р</span>, по цене <span class="стиль1">46 250р</span> за сотку.Есть разрешение на строительство.Цена без торга.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/map.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/4.jpg" alt="Фото 5">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-91/5.jpg" alt="Фото 6">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/4.jpg" alt="Фото 5">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-91/5.jpg" alt="Фото 6">
        </div>
    </div>
