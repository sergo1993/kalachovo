<?php
$this->title = "Продажа участка №200 в Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Продажа участка №200 в Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Продажа участка №200 </h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В первой части коттеджного поселка срочно продаётся участок №174, общая площадь участка 10,18 сотки. Стоимость земельного участка <span class="стиль2">400 000р</span>, цена за сотку <span class="стиль2">39 292р</span> это самая дешевая цена за сотку во всем поселке.На изображении приведенном ниже участок отмечен желтым цветом.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/6.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/4.jpg" alt="Фото 5">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-200/5.jpg" alt="Фото 6">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/6.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/4.jpg" alt="Фото 5">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-200/5.jpg" alt="Фото 6">
        </div>
    </div>
