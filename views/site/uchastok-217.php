<?php
$this->title = "Участок №217 рядом с д.Тарбаево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок №217 рядом с д.Тарбаево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок №217 рядом с д.Тарбаево.</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Продается участок ИЖС <span class="стиль1">37:05:030560:217</span> в деревне Калачево ТЭЦ-3.Размер 8 соток, находится в первой очереди деревни, неподалеку от д.Тарбаево. Проведено вынесение границ участка на местности, есть отчет геодезистов.По задней стороне участка уже выстроен забор из оцинкованного профлиста длиною 20м.По улице идет активная застройка соседями.Цена <span class="стиль1">310 000р</span> без торга, <span class="стиль1">38 750р</span> за сотку.</p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-217/aero.jpg" alt="Фото аэро">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-217/map.jpg" alt="Фото карта">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-217/1.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-217/2.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-217/3.jpg" alt="Фото 3">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-217/aero.jpg" alt="Фото аэро">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-217/map.jpg" alt="Фото карта">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-217/1.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-217/2.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-217/3.jpg" alt="Фото 3">
