<?php
$this->title = "301 участок 8 соток в поселке Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => '301 участок 8 соток в поселке Калачево'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">301 участок в поселке Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Во второй очереди поселка, по адресу улица Березовая, дом 24, кадастровый номер  37:05:030560:301, продаётся участок размером <span class="стиль1">8 соток</span> за <span class="стиль1">420</span><span class="стиль1"> 000р</span>, по цене <span class="стиль1">52 500р</span> за сотку. На данный момент это самый дешевый участок во второй очереди деревни.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-301/map.png" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-301/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-301/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-301/3.jpg" alt="Фото 4">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-301/map.png" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-301/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-301/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-301/3.jpg" alt="Фото 4">
