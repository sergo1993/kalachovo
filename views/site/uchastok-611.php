<?php
$this->title = "Участок №611 в коттеджном поселке Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок №611 в коттеджном поселке Калачево.'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок №611 в коттеджном поселке Калачево.</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Срочно продается участок ИЖС №611 в коттеджном поселке Калачево на ТЭЦ-3, размер участка 8,89 сотки. Участок под ИЖС на данный момент один из самых выгодных в третьей очереди поселка, его стоимость 430 000р, цена за сотку 48 368р.Расстояние до асфальта всего 170м.По фасаду участка проходят столбы ЛЭП, что освободит будущего собственника от дополнительных трат в размере 10 000р на установку бетонной опоры.Соседи уже построились и живут.            </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-611/aero 611.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-611/map 611.jpg" alt="Фото 2">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-611/aero 611.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-611/map 611.jpg" alt="Фото 2">
        </div>
    </div>
