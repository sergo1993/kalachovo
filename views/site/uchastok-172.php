<?php
$this->title = "Участок под ИЖС №172 в Калачево у дороги.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок под ИЖС №172 в первой части деревни'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок в первой очереди  Калачево №172</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В первой части поселка, в тихом месте продаётся участок №172, общей площадью 8,18 сотки по цене <span class="стиль3">380 000р  </span>, <span class="стиль3">за сотку 46 454р</span> .
                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-172/map.jpg" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-172/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-172/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-172/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-172/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-172/map.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-172/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-172/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-172/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-172/4.jpg" alt="Фото 5">
        </div>
    </div>
