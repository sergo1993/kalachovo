<?php
$this->title = "Участок под застройку в Калачево №482.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Участок под застройку в Калачево №482'
]);
...
<div class="container">
    ...
    </nav><nav class="mobile-menu" media="only screen and (max-device-width: 768px)">
        <ul class="">
            <li class="nav-item first active"><a class="second"
                                                 href="<?= Yii::$app->urlManager->createUrl('site/index'); ?>">О
                    проекте</a></li>
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Участок под застройку ИЖС в Калачево №482</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    Продается участок ИЖС №482 в деревне Калачево, размер участка 11,06 сотки. Участок под ИЖС стоимостью 510 000р находится в третьей очереди поселка с самой низкой ценой за сотку в этой части деревни, всего 46 112р. По фасаду участка проходит линия ЛЭП, что освободит будущего собственника от дополнительных затрат на установку бетонного столба. Участок угловой, что позволит организовать в будущем заезд с удобной стороны. Продаётся смежный участок №481 размером 8 соток, возможно объединить в один.
                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/map.jpg" alt="Фото 1">
			<img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/aero 482.jpg" alt="Фото 6">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-482/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-482/map.jpg" alt="Фото 1">
			<img style="margin: 20px auto; display: block;" src="/images/uchastok-482/aero 482.jpg" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-482/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-482/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-482/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-482/4.jpg" alt="Фото 5">
        </div>
    </div>
