<?php
$this->title = "Большой участок №116 в деревне Калачево.";


$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Большой участок №116 в деревне Калачево'
]);
...
<div class="container">
    ...
    <article class="main-content one-column">
        <section class="text-info">
            <div style="width: 100%" class="description"><h1 style="text-align: center">Большой участок №116 в деревне Калачево</h1>
                <p style="text-align: justify; text-indent: 30px; margin-bottom: 30px;">
                    В первой части поселка неподалеку от деревни Тарбаево срочно продается участок под ИЖС с кадастровым номером 37:05:030560:116, размером <span class="стиль1">10,03</span> сотки за <span class="стиль1">430 000р</span>, по цене <span class="стиль1">42 871р</span> за сотку.Участок правильной квадратной формы и угловой, что позволяет распланировать в будущем заезд с любой удобной стороны. Проведено вынесение границ, в крайних точках участка вбиты колышки.                </p>
            ...
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-116/map.png" alt="Фото 1">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-116/1.jpg" alt="Фото 2">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-116/2.jpg" alt="Фото 3">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-116/3.jpg" alt="Фото 4">
            <img class="go" style="margin: 20px auto; display: block;" src="/images/uchastok-116/4.jpg" alt="Фото 5">
    ...
    <div id="modal_form"><!-- Сaмo oкнo -->
        ...
        <div id="slider" class="slider_wrap">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-116/map.png" alt="Фото 1">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-116/1.jpg" alt="Фото 2">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-116/2.jpg" alt="Фото 3">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-116/3.jpg" alt="Фото 4">
            <img style="margin: 20px auto; display: block;" src="/images/uchastok-116/4.jpg" alt="Фото 5">
        </div>
    </div>
